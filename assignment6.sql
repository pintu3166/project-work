...
insert into worker values (19,'amogh','chatruvedi','data science',650000,'chatur12amogh@gmail.com','2010-01-05');
set sql_safe_updates=0;
update worker set date_of_joinning='2014-02-05' where customer_id=16;
update worker set date_of_joinning='2014-02-10' where customer_id=17;

select * from worker where date_of_joinning between '2014-02-01' and '2014-02-28';

select first_name, salary,count(*) from worker group by salary having count(*)>1;
select first_name, department,count(*) from worker group by department having count(*)>1;
